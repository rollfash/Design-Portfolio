...
const translations: Record<string, Record<Language, string>> = {
  ...
  "filter.residential": { he: "מגורים", en: "Residential" },
  "filter.commercial": { he: "מסחרי", en: "Commercial" },
  ...
  "services.hero.subtitle": { he: "אני מציע מגוון שירותי עיצוב המותאמים אישית לצרכים שלך. בין אם מדובר בשדרוג חדר בודד או בבניית מתחם מסחרי שלם, אני ניגש לכל פרויקט באותה רמת דיוק.", en: "I offer a range of design services tailored to your specific needs. Whether it's a single room update or a full commercial build-out, I approach every project with the same level of precision." },
  "services.process.discover": { he: "גילוי", en: "Discover" },
  "services.process.discover.desc": { he: "מתחילים בהבנת החזון, הצרכים והאילוצים הייחודיים של החלל.", en: "We start by understanding the vision, needs, and unique constraints of the space." },
  "services.process.design": { he: "עיצוב", en: "Design" },
  "services.process.design.desc": { he: "פיתוח קונספטים, הדמיות ופלטות חומרים כדי להפיח חיים בחזון.", en: "Developing concepts, renderings, and material palettes to bring the vision to life." },
  "services.process.execute": { he: "ביצוע", en: "Execute" },
  "services.process.execute.desc": { he: "ניהול הביצוע, הרכש וההתקנה להבטחת תוצאה מושלמת.", en: "Managing execution, procurement, and installation to ensure a flawless result." },
  "services.cta.title": { he: "מוכנים לשדרג את החלל?", en: "Ready to transform your space?" },
  "services.cta.subtitle": { he: "בואו נדבר על הפרויקט שלכם ונראה איך אפשר להפוך את החזון למציאות.", en: "Let's discuss your project and see how we can turn your vision into reality." },
  "services.cta.button": { he: "תיאום פגישת ייעוץ", en: "Book a Consultation" },
  "services.more_info": { he: "לפרטים נוספים", en: "Learn More" },

  // Service Items
  "service.residential.title": { he: "עיצוב פנים למגורים", en: "Residential Interior Design" },
  "service.residential.desc": { he: "שירותי עיצוב מלאים לבתים, מתכנון שיפוץ ועד בחירת הריהוט.", en: "Full design services for homes, from renovation planning to furniture selection." },
  ...
  "service.commercial.title": { he: "חללים מסחריים", en: "Commercial Spaces" },
  "service.commercial.desc": { he: "עיצוב סביבות מותג לחנויות, אירוח ומשרדים.", en: "Designing brand environments for retail, hospitality, and offices." },
  "service.styling.title": { he: "ייעוץ וסטיילינג", en: "Consultation & Styling" },
  "service.styling.desc": { he: "עין מקצועית לגימורים, אוצרות אמנות ואופטימיזציה של החלל.", en: "Professional eye for finishes, art curation, and space optimization." },
