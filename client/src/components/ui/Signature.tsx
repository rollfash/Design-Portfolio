    ...
    >
      ...
      >
        {paths.map((d, index) => {
          ...
          const pathProgress = useTransform(progress, [start, end], [0, 1], {
            clamp: true,
          });
          ...
          return (
            <motion.path
              ...
              style={{
                ...
                opacity: useTransform(pathProgress, [0, 0.01], [0, 1], {
                  clamp: true,
                }), // Fade in quickly to avoid dots
              }}
